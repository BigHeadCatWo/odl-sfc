 ...
 * <i>sfc-test-consumer-impl/test-b-read-sfc-rpc</i>
 *
 */
public abstract class TestBReadSfcRpc extends BaseIdentity
 {
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:params:xml:ns:yang:controller:config:sfc-test-consumer:impl",
        "2014-07-01", "test-b-read-sfc-rpc").intern();


    public TestBReadSfcRpc() {
