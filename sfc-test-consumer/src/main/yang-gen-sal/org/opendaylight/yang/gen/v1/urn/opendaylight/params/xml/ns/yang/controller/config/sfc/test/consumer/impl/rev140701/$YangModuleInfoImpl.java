...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sfc-test-consumer-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:sfc-test-consumer:impl";
    private final String revision = "2014-07-01";
    private final String resourcePath = "/META-INF/yang/sfc-test-consumer-impl@2014-06-12.yang";
