 ...
 * <i>sfc-test-consumer-impl/test-c-put-data-rpc</i>
 *
 */
public abstract class TestCPutDataRpc extends BaseIdentity
 {
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:params:xml:ns:yang:controller:config:sfc-test-consumer:impl",
        "2014-07-01", "test-c-put-data-rpc").intern();


    public TestCPutDataRpc() {
