 ...
 * <i>sfc-test-consumer-impl/test-a-delete-sf-rpc</i>
 *
 */
public abstract class TestADeleteSfRpc extends BaseIdentity
 {
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:params:xml:ns:yang:controller:config:sfc-test-consumer:impl",
        "2014-07-01", "test-a-delete-sf-rpc").intern();


    public TestADeleteSfRpc() {
