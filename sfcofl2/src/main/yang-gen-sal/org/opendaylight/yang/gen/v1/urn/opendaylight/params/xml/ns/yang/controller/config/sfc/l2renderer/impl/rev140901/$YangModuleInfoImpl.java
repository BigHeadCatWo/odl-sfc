package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.sfc.l2renderer.impl.rev140901 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sfc-l2renderer-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:sfc-l2renderer:impl";
    private final String revision = "2014-09-01";
    private final String resourcePath = "/META-INF/yang/sfcofl2-provider-impl.yang";
