...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sfc-vnf-manager-cfg";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:sfc:vnfm:spi";
    private final String revision = "2015-12-07";
    private final String resourcePath = "/META-INF/yang/sfc-vnf-manager-cfg.yang";
