package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.sfc.scf.openflow.provider.impl.rev140901 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sfc-scf-openflow-provider-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:sfc-scf-openflow-provider:impl";
    private final String revision = "2014-09-01";
    private final String resourcePath = "/META-INF/yang/sfc-scf-openflow-provider-impl.yang";
