...
public abstract class AbstractSfcScfOfRendererModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractSfcScfOfRendererModule> implements org.opendaylight.controller.config.yang.config.sfc_scf_openflow_provider.impl.SfcScfOfRendererModuleMXBean {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(org.opendaylight.controller.config.yang.config.sfc_scf_openflow_provider.impl.AbstractSfcScfOfRendererModule.class);
    ...
    public AbstractSfcScfOfRendererModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public AbstractSfcScfOfRendererModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractSfcScfOfRendererModule oldModule,java.lang.AutoCloseable oldInstance) {
    ...
    public boolean canReuseInstance(AbstractSfcScfOfRendererModule oldModule){
    ...
    public boolean isSame(AbstractSfcScfOfRendererModule other) {
        if (other == null) {
    ...
    if (o == null || getClass() != o.getClass()) { return false; }
        AbstractSfcScfOfRendererModule that = (AbstractSfcScfOfRendererModule) o;
