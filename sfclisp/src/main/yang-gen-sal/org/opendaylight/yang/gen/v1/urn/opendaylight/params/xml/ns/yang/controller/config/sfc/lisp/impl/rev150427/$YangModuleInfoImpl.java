package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.sfc.lisp.impl.rev150427 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sfc-lisp-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:sfc-lisp:impl";
    private final String revision = "2015-04-27";
    private final String resourcePath = "/META-INF/yang/sfc-lisp-impl.yang";
