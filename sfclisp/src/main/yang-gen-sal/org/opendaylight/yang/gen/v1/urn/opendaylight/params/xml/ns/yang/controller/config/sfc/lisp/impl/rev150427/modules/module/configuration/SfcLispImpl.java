 ...
 * <i>sfc-lisp-impl/modules/module/configuration/(urn:opendaylight:params:xml:ns:yang:controller:config:sfc-lisp:impl?revision=2015-04-27)sfc-lisp-impl</i>
 *
 */
public interface SfcLispImpl
    extends
    DataObject,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.sfc.lisp.impl.rev150427.modules.module.configuration.SfcLispImpl>,
    Configuration
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:params:xml:ns:yang:controller:config:sfc-lisp:impl",
        "2015-04-27", "sfc-lisp-impl").intern();
