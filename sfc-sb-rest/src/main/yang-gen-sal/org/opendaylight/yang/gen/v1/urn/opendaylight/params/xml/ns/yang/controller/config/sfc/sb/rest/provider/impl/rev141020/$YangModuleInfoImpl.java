package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.sfc.sb.rest.provider.impl.rev141020 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sfc-sb-rest-provider-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:sfc-sb-rest-provider:impl";
    private final String revision = "2014-10-20";
    private final String resourcePath = "/META-INF/yang/sfc-sb-rest-provider-impl.yang";
