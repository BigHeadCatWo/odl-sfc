...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sfc-vnfm-tacker";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:sfc:vnfm:tacker";
    private final String revision = "2015-12-23";
    private final String resourcePath = "/META-INF/yang/sfc-vnfm-tacker.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.sfc.vnfm.spi.rev151207.$YangModuleInfoImpl.getInstance());
